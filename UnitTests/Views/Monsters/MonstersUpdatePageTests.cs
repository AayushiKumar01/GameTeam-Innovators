...
namespace UnitTests.Views
{
    ...
    public class MonsterUpdatePageTests : MonsterUpdatePage
    {
        ...
        [Test]
        public void MonsterUpdatePage_EnableImageArrowButtons_Valid_Image1_Should_Disable_Left()
        {
            // Arrange
        ...
        [Test]
        public void MonsterUpdatePage_EnableImageArrowButtons_Valid_Image2_Should_Enable_Both()
        {
            // Arrange
            var LeftButton = (Button)page.FindByName("LeftArrowButton");
            var RightButton = (Button)page.FindByName("RightArrowButton");
        ...
        [Test]
        public void MonsterUpdatePage_EnableImageArrowButtons_Valid_Image8_Should_Disable_Right()
        {
            // Arrange
            var LeftButton = (Button)page.FindByName("LeftArrowButton");
            var RightButton = (Button)page.FindByName("RightArrowButton");
