...
namespace Game.GameRules
{
    public static class RandomPlayerHelper
    {
        ...
        public static string GetMonsterImage()
        {
            ...
            List<string> FirstNameList = new List<string> { "monsterdrafts1.png", "monsterdrafts2.png", "monsterdrafts3.png", "monsterdrafts4.png", "monsterdrafts5.png", "monsterdrafts6.png" };
        ...
        public static string GetCharacterImage()
        {
            ...
            List<string> FirstNameList = new List<string> { "ship1.png", "ship2.png", "ship3.png", "ship4.png", "ship5.png", "ship6.png", "ship1.png" };
